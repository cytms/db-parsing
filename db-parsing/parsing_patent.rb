...
#File.open("parsing_patent_withfiled_2007.log", "a") do |aFile|
    ...
    #some parameters
    last = -30		#the last queried number of entry in content_#{year}  #182815 (7301016)XX #start from -number
    number = 30 	#number of rows for each query
    year = 1999		#the last processing year
    table = "content_"	#prefix
    tableorigin = "uspto_"

    while ( year < 2002 ) #should be 2010 
